...
package com.infomaniak.lib.login.crossapp.certificates

internal class AppCertificateCheckerImpl(
    private val signingCertificates: AppSigningCertificates
) : AppCertificateChecker {

    override fun isUidAllowed(uid: Int): Boolean {
        if (uid == -1) return false
        TODO("Leverage DynamicLazyMap once this is moved to android-Core")
    }
}
