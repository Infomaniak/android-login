...
import com.infomaniak.lib.login.crossapp.certificates.AppCertificateChecker
import com.infomaniak.lib.login.crossapp.certificates.AppCertificateCheckerImpl
import com.infomaniak.lib.login.crossapp.certificates.infomaniakAppsCertificates
import com.infomaniak.lib.login.crossapp.internal.ChannelMessageHandler
import com.infomaniak.lib.login.crossapp.internal.DisposableMessage
...
abstract class BaseCrossAppLoginService : LifecycleService() {
    ...
    protected abstract val accountsFlow: Flow<ExternalAccount>
